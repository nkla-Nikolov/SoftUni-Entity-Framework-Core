namespace SoftJail.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        {
            var serializer = new XmlSerializer(typeof(List<OfficerPrisonerDto>), new XmlRootAttribute("Officers"));
            var sb = new StringBuilder();

            var officerDtos = (List<OfficerPrisonerDto>)serializer.Deserialize(new StringReader(xmlString));
